...
![Gato estudando com óculos. Prompt: Create an image of a computer maintenance technician cat](../../../../assets/images/gpt/cat_hardware2.jpg)Gato técnico em manutenção de computadoresFonte: gerado por IA com Bing por Maxwell Anderson (2023)
...
> \[1\]: Para ser ter uma ideia, a [Bíblia Sagrada contém cerca de _3.799.922_ caracteres](https://augustomen.wordpress.com/2017/03/01/quantos-versiculos-ha-em-cada-capitulo-da-biblia/), incluíndo espaços e pontuação. Então temos que:
> 
> *   _3.799.922_ caracteres = _3.799.922_ bytes
> *   _3.799.922_ bytes = 3.710,86 KiB ou 3.799,92 KB
> *   _3.799.922_ bytes = 3,623 MiB ou 3,79 MB

_E o que vem a ser MiB?_

MiB ou Mebibyte é uma unidade de medida de informação que representa 220 bytes.

O KiB ou Quibibyte é uma unidade de medida de informação que representa 210 bytes.
...
| Milímetro | mm | 10\-3 | 0,001 |
| Micrômetro | µm | 10\-6 | 0,000001 |
| Nanômetro | nm | 10\-9 | 0,000000001 |
| Picômetro | pm | 10\-12 | 0,000000000001 |
| Fentômetro | fm | 10\-15 | 0,000000000000001 |
| Atômetro | am | 10\-18 | 0,000000000000000001 |
