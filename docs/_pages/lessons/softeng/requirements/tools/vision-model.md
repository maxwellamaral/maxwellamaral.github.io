...
Os detalhes de como o **Sistema Lorem Ipsum** atingem essas necessidades são descritos nas *especificações de casos de uso* e nos *requisitos funcionais*.
